module github.com/jasonashworth001/filestash
...
require (
	...
	github.com/mickael-kerjean/filestash v0.0.0-00010101000000-000000000000
...
replace github.com/mickael-kerjean/filestash => ./
